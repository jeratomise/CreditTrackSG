...
import { Save, Bell, Mail, Clock, Lock, CheckCircle, AlertCircle, Loader2, ShieldCheck, Sparkles, ExternalLink, Copy, Users, Gift, Share2 } from 'lucide-react';
                ...
                <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        {[
                            ...
                            { label: 'Pro Months', value: referralStats.proMonthsEarned, icon: <span className="text-amber-400">⭐</span> },
                        ].map((stat) => (
